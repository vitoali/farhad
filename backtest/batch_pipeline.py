...
INDICATOR_REGISTRY: dict[str, tuple[str, int, str]] = {
  # Already ported (#1-19)
    ...
    "FxPipFinder_Engagement_Zone_41e2.txt": ("fxpip_scob", 37, "FxPipFinder SCOB"),
    "Buyside___Sellside_Liquidity_631a.txt": ("buyside_liquidity", 38, "Buyside/Sellside Liquidity"),
    "Support_and_Resistance_Signals__bc86.txt": ("sr_signals_mtf", 39, "SR Signals MTF"),
    "Divergence_for_Many_Indicators_2408.txt": ("divergence", 40, "Divergence Many Indicators"),
    "Divergence_for_many_indicator_2b36.txt": ("divergence", 40, "Divergence Many Indicators"),
    "Order-Flow_Detection_d054.txt": ("orderflow_print", 41, "OrderFlow Absorption"),
    "Fair_Value_Gap_f587.txt": ("fair_value_gap", 42, "Fair Value Gap LuxAlgo"),
    "FVG___IFVG_ICT_a586.txt": ("fair_value_gap", 42, "FVG ICT"),
    "fvg_1bce.txt": ("fvg_retest", 21, "FVG Retest Engine"),
    "smart_mony_fibo_67b7.txt": ("fib_ote", 43, "Smart Money Fib OTE"),
    "mirage_8451.txt": ("buyside_liquidity", 38, "Mirage LSP sweep"),
    "quadpad_9f11.txt": ("quadapt", 6, "Quadapt ML"),
    "quadapt_ml_trader.pine": ("quadapt", 6, "Quadapt ML"),
    "atomatic_multi_pattern__9980.txt": ("forge", 4, "FORGE"),
    "auto_pattern_detector_bf37.txt": ("forge", 4, "FORGE pattern"),
    "forge_v1.pine": ("forge", 4, "FORGE"),
    "SMART_MONEY_11c2.txt": ("smc_pro_alt", 24, "SMC LuxAlgo"),
    "New_Text_Document_ee2a.txt": ("ifvg", 10, "ICT Rebalance/IFVG"),
    "qt_cx_7542.txt": ("matrix_fvg", 25, "QT Cx FVG"),
    "HISTORICAL_POPTRN_8ffc.txt": ("forge", 4, "Pattern projection"),
    # Batch #44+ (new uploads)
    "mirage_d9ef.txt": ("mirage_lsp", 44, "Mirage LSP Full"),
    "mirage_8451.txt": ("mirage_lsp", 44, "Mirage LSP"),
    "4_7c06.txt": ("trendmaster", 45, "TrendMaster Pro 2.3"),
    "3_2c7c.txt": ("pmax", 46, "PMax Explorer"),
    "volon_trend_order_block_93f7.txt": ("volume_ob_retest", 47, "Volume-Trend OB Retest"),
    "volon_trend_order_block_72a5.txt": ("volume_ob_retest", 47, "Volume-Trend OB"),
    "dynamic_trend_125b.txt": ("dynamic_trend", 48, "Dynamic Trend Bands"),
    "dynamic_trend_8e17.txt": ("dynamic_trend", 48, "Dynamic Trend Bands"),
    "QUANTOM_4e3d.txt": ("quantum_imbalance", 49, "Quantum Imbalance Trap"),
    "QUANTOM_4271.txt": ("quantum_imbalance", 49, "Quantum Imbalance"),
    "multi_divergence_40f7.txt": ("multi_div", 50, "Multi-Divergence GainzAlgo"),
    "multi_divergence_3058.txt": ("multi_div", 50, "Multi-Divergence"),
    "MACHIN_6545.txt": ("knn_pivot", 51, "KNN Pivot ML"),
    "MACHIN_a826.txt": ("knn_pivot", 51, "KNN Pivot ML"),
    "high_volom_pivoty_suport_809e.txt": ("hv_pivot_sr", 52, "HV Pivot S/R"),
    "high_volom_pivoty_suport_778c.txt": ("hv_pivot_sr", 52, "HV Pivot S/R"),
    "STOP_HUNT_c561.txt": ("stop_hunt", 22, "Stop Hunt Radar"),
    "power_order_bloc_813f.txt": ("power_ob", 30, "Power Order Blocks"),
    "suply_demand_zone_9eee.txt": ("supply_demand", 18, "Supply/Demand Zone"),
    "cardvel_7430.txt": ("cardwell_rsi", 20, "Cardwell RSI"),
    "FVG_G_3a49.txt": ("fair_value_gap", 42, "FVG G"),
    "FVG___IFVG_ICT_ada8.txt": ("ifvg", 10, "FVG/IFVG ICT"),
    "ORDER_711e.txt": ("matrix_fvg", 25, "Order Flow Matrix"),
    "qt_cx_ae81.txt": ("matrix_fvg", 25, "QT Cx FVG"),
    "LONG_SEL_db3c.txt": ("strong_pullback", 19, "Long Selection Pullback"),
    "HISTORICAL_POPTRN_e03d.txt": ("forge", 4, "Historical Pattern"),
    "atomatic_multi_pattern__1b51.txt": ("forge", 4, "Auto Multi Pattern"),
    "auto_pattern_detector_a39f.txt": ("forge", 4, "Auto Pattern Detector"),
    "whale_liquidy_zone_ebd2.txt": ("liquidity_pool", 32, "Whale Liquidity Zone"),
    "whale_liquidy_zone_181a.txt": ("liquidity_pool", 32, "Whale Liquidity"),
    "machin_learning_rsi_335f.txt": ("ml_rsi", 17, "ML RSI"),
    "machin_learning_rsi_217a.txt": ("ml_rsi", 17, "ML RSI"),
    "smart_mony_fibo_9951.txt": ("fib_ote", 43, "Smart Money Fib"),
    "2_829e.txt": ("bj_bot", 3, "Bj Bot v2"),
}
